...
exports.invoke = (type, name) => {
  ...
  switch (type) {
    ...
    case 'v':
      ...
      break;
    default:
      console.log(chalk.red(`ERROR: uncaught type , you should input like $ csv g c list`));
      console.log();
      ...
      console.log('    $ csv g c list');
      console.log('    $ csv g c activity/list');
      console.log();
      console.log(chalk.gray('    # create a new service'));
      console.log('    $ csv g s list');
      console.log('    $ csv g s activity/list');
      console.log();
      console.log(chalk.gray('    # create a new view'));
      console.log('    $ csv g v list');
      console.log('    $ csv g v activity/list');
      console.log();
